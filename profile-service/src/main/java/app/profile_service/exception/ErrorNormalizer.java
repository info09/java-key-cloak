package app.profile_service.exception;

import app.profile_service.dto.identity.KeyCloakError;
...
public class ErrorNormalizer {
    ...
    public ErrorNormalizer(Map<String, ErrorCode> errorCodeMap, ObjectMapper objectMapper) {
        this.errorCodeMap = errorCodeMap;
        this.objectMapper = objectMapper;

        this.errorCodeMap.put("User exists with same username", ErrorCode.USERNAME_EXISTED);
        this.errorCodeMap.put("User exists with same email", ErrorCode.EMAIL_EXISTED);
        this.errorCodeMap.put("User name is missing", ErrorCode.USERNAME_IS_MISSING);
    }
